...
<targets>
  ...
  &lt;target </xsl:text>
      ...
      <xsl:if test="$isWrapper">
        <xsl:text>    </xsl:text><xsl:text disable-output-escaping="yes">&lt;target xsi:type="wrappedTargetType" ...target properties... /&gt;
        </xsl:text>
      </xsl:if>

      <xsl:if test="$isCompound">
        <xsl:text>    </xsl:text><xsl:text disable-output-escaping="yes">&lt;target xsi:type="wrappedTargetType" ... /&gt;</xsl:text>
        <xsl:text disable-output-escaping="yes">    &lt;target xsi:type="wrappedTargetType" ... /&gt;</xsl:text>
        <xsl:text>    ...</xsl:text>
        <xsl:text disable-output-escaping="yes">    &lt;target xsi:type="wrappedTargetType" ... /&gt;</xsl:text>
...
_</xsl:text><xsl:value-of select="@camelName"/>
      ...
      <xsl:if test="not(@type='Enum') and not (@type='String')">
         ...
         <xsl:text> [`</xsl:text> <xsl:value-of select="@type"/> <xsl:text>`](Data-types)</xsl:text>
